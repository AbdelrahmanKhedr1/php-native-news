    ...
    <div class="row height d-flex justify-content-center align-items-center">
        <div class="col-md-7">
            <div class="card">
                ...
                <form action="{{url('add/comment?news_id='.request('id'))}}" method="post" id="comment_form">
                    ...
                    <div class="mt-3 d-flex flex-row align-items-center p-3 form-color">
                        ...
                        <textarea class="form-control" placeholder="{{ trans('main.write_comment') }}" name="comment"></textarea>
                    </div>
                    <button type="button" class="btn btn-success add_comment "> {{trans('main.add')}} </button>
                </form>
